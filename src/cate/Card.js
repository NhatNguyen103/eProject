      ...
      <section className="card">
        ...
        <div className="card-detail">
          ...
          <div className='button-fan'>
            ...
            <div className='dbtn-conteiner'>
              <button className='dbtn-content' onClick={() => navigate(`/Categories/${id}`)}>
                <p>Show more</p>
                <span class="icon-arrow">
                  <svg width="66px" height="43px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmln xlink="http://www.w3.org/1999/xlink">
